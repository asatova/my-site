...
[data-lzl-stck].js-lzl-ing:is(.et_pb_sticky_placeholder) {
	display: none!important;
}

[data-lzl-stck].js-lzl-ing.lzl-sticky + .lzl-sticky-spacer {
	display: block!important;
	width: 100%;
}' );
...

		{
			...
			if( apply_filters( 'seraph_accel_jscss_addtype', false ) )
				$itemScript -> setAttribute( 'type', 'text/javascript' );
			$itemScript -> setAttribute( 'seraph-accel-crit', '1' );
			HtmlNd::SetValFromContent( $itemScript, "function seraph_accel_cp_diviStck_calcSizes(a){function c(b,e=!0){var f=et_pb_sticky_elements[b.getAttribute(\"data-lzl-stck\")];f&&(e?(b.classList.add(\"lzl-sticky\"),b.classList.add(\"et_pb_sticky\"),b.classList.add(\"et_pb_sticky--\"+String(f.position))):(b.classList.remove(\"lzl-sticky\"),b.classList.remove(\"et_pb_sticky\"),b.classList.remove(\"et_pb_sticky--top\")))}if(a.classList.contains(\"et_pb_sticky_placeholder\"))return!1;var d=a.nextElementSibling;d&&d.classList.contains(\"lzl-sticky-spacer\")&&(d.style.setProperty(\"height\",\n\"\"+a.clientHeight+\"px\"),0<d.getBoundingClientRect().top&&c(a,!1));0>=a.getBoundingClientRect().top&&c(a,!0);return!0}\n(function(a){function c(d){var b=!0;a.querySelectorAll(\"[data-lzl-stck]\").forEach(function(e){seraph_accel_cp_diviStck_calcSizes(e)||(b=!1)});b||(a.querySelectorAll(\"[data-lzl-stck]\").forEach(function(e){e.classList.remove(\"js-lzl-ing\")}),a.removeEventListener(\"seraph_accel_calcSizes\",c,{capture:!0,passive:!0}),a.removeEventListener(\"scroll\",c,{capture:!0,passive:!0}))}a.addEventListener(\"seraph_accel_calcSizes\",c,{capture:!0,passive:!0});a.addEventListener(\"scroll\",c,{capture:!0,passive:!0});seraph_accel_izrbpb.add(function(){a.querySelectorAll(\"[data-lzl-stck]\").forEach(function(d){d.classList.remove(\"js-lzl-ing\")});\na.removeEventListener(\"seraph_accel_calcSizes\",c,{capture:!0,passive:!0});a.removeEventListener(\"scroll\",c,{capture:!0,passive:!0})})})(document)" );
			$ctxProcess[ 'ndBody' ] -> insertBefore( $itemScript, $ctxProcess[ 'ndBody' ] -> firstChild );
		}
...
function _ProcessCont_Cp_elmntrHdr( $ctx, &$ctxProcess, $doc, $xpath )
{
	...
	if( $item && ContentProcess_IsItemInFragments( $ctxProcess, $item ) )
	{
		...
		$itemCont = HtmlNd::FirstOfChildren( $xpath -> query( './*[contains(concat(" ",normalize-space(@class)," ")," elementor-section-wrap ")]', $item ) );
		if( !$itemCont )
			$itemCont = $item;

		foreach( HtmlNd::ChildrenAsArr( $xpath -> query( './*[contains(concat(" ",normalize-space(@class)," ")," elementor-top-section ")][contains(@data-settings,"sticky")]', $itemCont ) ) as $itemSticky )
		{
			$adjusted = true;
			...
			$itemStickySpacer = HtmlNd::CreateTag( $doc, $itemSticky -> nodeName, array( 'class' => array( 'lzl-sticky-spacer' ), 'style' => array( 'display' => 'none' ) ) );
			HtmlNd::InsertAfter( $itemSticky -> parentNode, $itemStickySpacer, $itemSticky );
		}

		if( $adjusted )
		{
			HtmlNd::AddRemoveAttrClass( $itemCont, array( 'js-lzl-hdrcont', 'js-lzl-ing' ) );

			{
				...
				$itemCont -> appendChild( $itemScript );
			}
		}
	}
	...
	if( $ctxProcess[ 'mode' ] == 'full' && $adjusted )
	{
...

		{
			...
			if( apply_filters( 'seraph_accel_jscss_addtype', false ) )
				$itemsCmnStyle -> setAttribute( 'type', 'text/css' );
			HtmlNd::SetValFromContent( $itemsCmnStyle, '.js-lzl-hdrcont.js-lzl-ing .elementor-top-section.lzl-sticky {
	position: fixed;
	width: 100%;
	margin-top: 0px;
	margin-bottom: 0px;
...
.js-lzl-hdrcont.js-lzl-ing :is(.elementor-sticky__spacer,.the7-e-sticky-spacer) {
	display: none!important;
}

.js-lzl-hdrcont.js-lzl-ing .elementor-top-section.lzl-sticky + .lzl-sticky-spacer {
	display: block!important;
	width: 100%;
}' );
...

		{
			...
			if( apply_filters( 'seraph_accel_jscss_addtype', false ) )
				$itemScript -> setAttribute( 'type', 'text/javascript' );
			$itemScript -> setAttribute( 'seraph-accel-crit', '1' );
			HtmlNd::SetValFromContent( $itemScript, "function seraph_accel_cp_elmntrHdr_calcSizes(c){for(var d=0,e,f=!0,g=0;g<c.childNodes.length;g++){var a=c.childNodes[g];if(a.nodeType==Node.ELEMENT_NODE)if(a.classList.contains(\"lzl-sticky-spacer\"))a.style.setProperty(\"height\",\"\"+d+\"px\"),0<a.getBoundingClientRect().top&&e&&e.classList.remove(\"lzl-sticky\");else if(a.classList.contains(\"elementor-sticky__spacer\")||a.classList.contains(\"the7-e-sticky-spacer\"))f=!1;else if(a.classList.contains(\"elementor-top-section\")&&(d=0,e=void 0,a.clientHeight&&a.clientWidth)){try{var b=\nJSON.parse(a.getAttribute(\"data-settings\"))}catch(m){}b||(b={});if(\"top\"==b.sticky||\"top\"==b.ekit_sticky){try{var h=JSON.parse(a.getAttribute(\"data-lzl-sticky-widths\"))}catch(m){}h||(h=[]);var l=!1,k;for(k in h)if(window.innerWidth>=h[k][0]&&window.innerWidth<=h[k][1]){l=!0;break}l&&(void 0===b.sticky_offset||b.sticky_offset?(\"yes\"==b.jet_sticky_section&&(window.scrollY?(a.classList.add(\"jet-sticky-section--stuck\"),a.classList.add(\"jet-sticky-transition-in\")):(a.classList.remove(\"jet-sticky-section--stuck\"),\na.classList.remove(\"jet-sticky-transition-in\"))),b.ekit_sticky_offset&&\"px\"==b.ekit_sticky_offset.unit&&(window.scrollY>=b.ekit_sticky_offset.size?(a.style.setProperty(\"position\",\"fixed\"),a.style.setProperty(\"top\",\"0\"),a.style.setProperty(\"width\",\"100%\"),a.classList.add(\"ekit-sticky\"),a.classList.add(\"ekit-sticky--active\")):(a.style.removeProperty(\"position\",\"fixed\"),a.style.removeProperty(\"top\",\"0\"),a.classList.remove(\"ekit-sticky\"),a.classList.remove(\"ekit-sticky--active\"))),b.ekit_sticky_effect_offset&&\n\"px\"==b.ekit_sticky_effect_offset.unit&&(window.scrollY>=b.ekit_sticky_effect_offset.size?a.classList.add(\"ekit-sticky--effects\"):a.classList.remove(\"ekit-sticky--effects\"))):(e=a,d=a.clientHeight,0>=a.getBoundingClientRect().top&&a.classList.add(\"lzl-sticky\")))}}}f||c.classList.remove(\"js-lzl-ing\");return f}\n(function(c){function d(e){var f=!0;c.querySelectorAll(\".js-lzl-hdrcont\").forEach(function(g){seraph_accel_cp_elmntrHdr_calcSizes(g)||(f=!1)});f||(c.removeEventListener(\"seraph_accel_calcSizes\",d,{capture:!0,passive:!0}),c.removeEventListener(\"scroll\",d,{capture:!0,passive:!0}))}c.addEventListener(\"seraph_accel_calcSizes\",d,{capture:!0,passive:!0});c.addEventListener(\"scroll\",d,{capture:!0,passive:!0});c.addEventListener(\"seraph_accel_jsFinish\",function(e){c.removeEventListener(\"scroll\",d,{capture:!0,\npassive:!0});d(e)},{capture:!0,passive:!0})})(document)" );
			$ctxProcess[ 'ndBody' ] -> insertBefore( $itemScript, $ctxProcess[ 'ndBody' ] -> firstChild );
		}
	}
}
